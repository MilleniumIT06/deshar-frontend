...
const Modal = ({ isOpen, onClose, children, closeOnOverlayClick, variant, className }: ModalProps) => {
	...
	return ReactDOM.createPortal(
		<div className="Modal__overlay" onClick={closeOnOverlayClick ? onClose : undefined}>
			<div className={cn(modalVariants({ variant }), className && className)}>
				<Button variant="iconSecondary" size="iconSmall" className="Modal__close_btn" onClick={onClose}>
