...
export const trainersMap: Record<TrainerType, ComponentType<any>> = {
	...
	delete_extra_letter: dynamic(() => import('../../trainers/DeleteExtraLetter').then(mod => mod.DeleteExtraLetter), {
		ssr: false,
		loading: () => <div>Loading...</div>,
	}),
	multi_quiz: dynamic(() => import('../../trainers/MultiSelectVariantsQuiz').then(mod => mod.MultiSelectVariantsQuiz), {
		ssr: false,
		loading: () => <div>Loading...</div>,
	}),
	...
	single_quiz: dynamic(() => import('../../trainers/SingleSelectVariantQuiz').then(mod => mod.SingleSelectVariantQuiz), {
		ssr: false,
		loading: () => <div>Loading...</div>,
	}),
	...
	alphabetic_sorter: dynamic(() => import('../../trainers/AlphabeticalSorter').then(mod => mod.AlphabeticalSorter), {
		ssr: false,
		loading: () => <div>Loading...</div>,
	}),
	...
	single_select_image_quiz: dynamic(() => import('../../trainers/SingleSelectImageQuiz').then(mod => mod.SingleSelectImageQuiz), {
		ssr: false,
		loading: () => <div>Loading...</div>,
	}),
	phrase_image_matcher: dynamic(() => import('../../trainers/PhraseImageMatcher').then(mod => mod.PhraseImageMatcher), {
		ssr: false,
		loading: () => <div>Loading...</div>,
	}),
