...
export function useLessonPracticeData({ moduleId, pieceId, currentLesson, mode, activeTaskIndex }: UseLessonPracticeDataParams) {
	...
	} = useGetLessonUniqueTask(moduleId, pieceId, lessonId, activeTask?.id, Boolean(mode === 'practice' && activeTask?.id))
	return {
		taskData,
		isTaskListLoading,
		activeTask,
