			...
			<div className="Card__inner">
				<div className="Card__header">
					<div className="Card__header-top">
						...
						{(type === 'class' &&
							hasRole(['Представитель школы', 'Пр. Управления образования', 'Представитель министерства', 'Админ'])) ||
						isParallel ? (
					...
					<div className="Card__controls">
						{tabs.length > 0 && activeTab && setActiveTab ? (
								...
								<div className="Card__filters-list">
									{filters.map((filter, index) => {
										if (filter.type === 'status') {
											return (
												<div className="Card__inputSelect_wrapper" key={`${filter.type}-${index}`}>
													<span>Статус</span>
													<InputSelect
														variant="admin"
