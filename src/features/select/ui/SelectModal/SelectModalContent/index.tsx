	...
	return (
		<div className={styles.index}>
			...
			<div className={styles.index__btns}>
				<Button variant="secondary" size="small" className={styles.index__btn} onClick={onClose}>
					Отмена
				</Button>
				<Button variant="primary" size="small" className={styles.index__btn} onClick={handleClickStartBtn}>
					Начать
				</Button>
			</div>
		</div>
