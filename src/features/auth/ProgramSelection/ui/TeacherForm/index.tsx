			...
			<div className="TeacherForm__inner">
				...
				<form onSubmit={form.handleSubmit(onSubmit)} className="TeacherForm__form">
					<div className="TeacherForm__field">
						...
						/>
						{form.formState.errors.district && <p className="TeacherForm__error">{form.formState.errors.district.message}</p>}
					</div>
					<div className="TeacherForm__field">
						<InputSelect
						...
						/>
						{form.formState.errors.locality && <p className="TeacherForm__error">{form.formState.errors.locality.message}</p>}
					</div>
					...
					<div className="TeacherForm__field">
						...
						/>
						{form.formState.errors.school && <p className="TeacherForm__error">{form.formState.errors.school.message}</p>}
					</div>
