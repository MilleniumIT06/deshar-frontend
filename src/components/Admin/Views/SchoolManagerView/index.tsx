	...
	return (
		<div className="SchoolManagerView">
			...
			<div className="MainStatisticPageContent__result_cards">
				{isSchoolStatisticsLoading ? (
					<Loader />
				) : (
					schoolStatisticAdminData && (
						<>
							<ResultsCard
								percent={25}
								period={7}
