...
const EngineInput = forwardRef<HTMLInputElement, InputProps>(
	({ label, fullWidth, className, type, error = false, startAdornment, endAdornment, validationMessage, id, ...props }, ref) => {
		...
		return (
			<div className={containerClasses}>
				...
				<div className="engine-input__field-wrapper">
					{startAdornment && <span className="engine-input__adornment engine-input__adornment--start">{startAdornment}</span>}
					...
					{!isPassword && endAdornment && <span className="engine-input__adornment engine-input__adornment--end">{endAdornment}</span>}
				</div>
