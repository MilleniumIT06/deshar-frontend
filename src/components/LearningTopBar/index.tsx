	...
	return (
		<div className="LearningTopBar">
			<div className="LearningTopBar__inner">
				<div className="LearningTopBar__navigation">
					<Button variant="iconSecondary" size="iconSmall">
						<svg width="10" height="16" viewBox="0 0 10 16" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path d="M9.33398 14.666L1.83399 7.99935L9.33398 1.33268" stroke="#303030" strokeWidth="2" />
						</svg>
					</Button>
				...
				/>
				<h2 className="LearningTopBar__title">Орфография как система правил правописания слов и форм слов</h2>
			</div>
		</div>
	)
}
